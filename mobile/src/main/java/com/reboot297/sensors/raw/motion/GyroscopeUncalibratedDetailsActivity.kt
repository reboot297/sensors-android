...
class GyroscopeUncalibratedDetailsActivity : BaseSensorActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            sensorDescriptionView.setText(R.string.description_gyroscope_uncalibrated)
        }
    }
