...
class OrientationDetailsActivity : BaseActivity(), SensorEventListener {
    ...
    private fun displaySensorInfo(sensor: Sensor) = with(binding) {
        ...
        sensorMaxRangeValue.text = getString(R.string.format_unit_orientation, sensor.maximumRange)
        sensorResolutionValue.text = getString(R.string.format_unit_orientation, sensor.resolution)
        ...
        sensorUnitValue.text = getString(R.string.unit_orientation)
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        event?.values?.let {
            binding.sensorValueXView.text = getString(R.string.format_unit_orientation, it[0].toString())
            binding.sensorValueYView.text = getString(R.string.format_unit_orientation, it[1].toString())
            binding.sensorValueZView.text = getString(R.string.format_unit_orientation, it[2].toString())
        }
    }
