...
class RotationVectorDetailsActivity : BaseSensorActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            sensorDescriptionView.setText(R.string.description_rotation_vector)
        }
    }
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        event?.values?.let {
            binding.sensorDataLayout.sensorValueView.text = formatRotationVector(it)
        }
    }
