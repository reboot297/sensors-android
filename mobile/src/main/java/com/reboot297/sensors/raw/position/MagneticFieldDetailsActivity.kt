...
class MagneticFieldDetailsActivity : BaseActivity(), SensorEventListener {
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        event?.values?.let {
            binding.sensorValueXView.text = getString(R.string.format_unit_magnetic_field, it[0].toString())
            binding.sensorValueYView.text = getString(R.string.format_unit_magnetic_field, it[1].toString())
            binding.sensorValueZView.text = getString(R.string.format_unit_magnetic_field, it[2].toString())
        }
    }
