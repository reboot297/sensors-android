...
class GravityDetailsActivity : BaseSensorDetailsActivity(), SensorEventListener {
    ...
    override fun createSectionsUI() = SectionUIImpl(
        sensorValue = ThreeSensorValues(unit = getString(R.string.unit_gravity)),
        accuracyValue = AccuracySensorValue(applicationContext),
        sensorInfo = SensorInfo(applicationContext, getString(R.string.unit_gravity)),
        description = Description(R.string.description_gravity)
    )
