...
import com.reboot297.sensors.databinding.ActivityRawTemperatureBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.TemperatureLifecycleObserver

class TemperatureDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = TemperatureLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawTemperatureBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawTemperatureBinding.inflate(layoutInflater)
