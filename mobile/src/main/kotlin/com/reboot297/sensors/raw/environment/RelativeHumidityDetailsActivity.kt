...
import com.reboot297.sensors.databinding.ActivityRawRelativeHumidityBinding
...
class RelativeHumidityDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = RelativeHumidityLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawRelativeHumidityBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawRelativeHumidityBinding.inflate(layoutInflater)
