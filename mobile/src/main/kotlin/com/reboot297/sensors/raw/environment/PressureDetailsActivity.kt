...
import com.reboot297.sensors.databinding.ActivityRawPressureBinding
...
class PressureDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawPressureBinding.inflate(layoutInflater)
        ...
        with(binding) {
            ...
            samplesLabelView.handleVisibility(sampleAltitudeView)
            sampleAltitudeView.setOnClickListener { openSample(AltitudeActivity::class.java) }
        }
    }
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unit_pressure))
    }
