...
import com.reboot297.sensors.databinding.ActivityRawLightBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.LightLifecycleObserver

class LightDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = LightLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawLightBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawLightBinding.inflate(layoutInflater)
