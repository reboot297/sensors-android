...
import com.reboot297.sensors.databinding.ActivityRawGravityBinding
...
class GravityDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawGravityBinding.inflate(layoutInflater)
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unit_gravity))
    }
