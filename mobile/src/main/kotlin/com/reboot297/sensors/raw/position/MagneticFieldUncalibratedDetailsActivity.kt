...
import com.reboot297.sensors.databinding.ActivityRawMagneticFieldUncalibratedBinding
...
class MagneticFieldUncalibratedDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawMagneticFieldUncalibratedBinding.inflate(layoutInflater)
