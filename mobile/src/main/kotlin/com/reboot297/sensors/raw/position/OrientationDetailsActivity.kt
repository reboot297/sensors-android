...
import com.reboot297.sensors.databinding.ActivityRawOrientationBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.OrientationLifecycleObserver

class OrientationDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = OrientationLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawOrientationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawOrientationBinding.inflate(layoutInflater)
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unit_orientation))
    }
