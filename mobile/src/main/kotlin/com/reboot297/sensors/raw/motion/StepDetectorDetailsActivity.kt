...
import com.reboot297.sensors.databinding.ActivityRawStepDetectionBinding
...
class StepDetectorDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    lateinit var binding: ActivityRawStepDetectionBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawStepDetectionBinding.inflate(layoutInflater)
