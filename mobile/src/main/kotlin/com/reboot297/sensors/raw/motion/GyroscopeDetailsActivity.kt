...
import com.reboot297.sensors.databinding.ActivityRawGyroscopeBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.GyroscopeLifecycleObserver

class GyroscopeDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = GyroscopeLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawGyroscopeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawGyroscopeBinding.inflate(layoutInflater)
