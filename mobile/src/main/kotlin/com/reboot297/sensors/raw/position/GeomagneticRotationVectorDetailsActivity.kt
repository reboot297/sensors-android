...
import com.reboot297.sensors.databinding.ActivityRawGeomagneticRotationVectorBinding
...
class GeomagneticRotationVectorDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawGeomagneticRotationVectorBinding.inflate(layoutInflater)
