...
import com.reboot297.sensors.databinding.ActivityRawGameRotationVectorBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.GameRotationVectorLifecycleObserver

class GameRotationVectorDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = GameRotationVectorLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawGameRotationVectorBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawGameRotationVectorBinding.inflate(layoutInflater)
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unitless))
    }
