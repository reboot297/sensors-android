...
import com.reboot297.sensors.databinding.ActivityRawGyroscopeUncalibratedBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.GyroscopeUncalibratedLifecycleObserver

class GyroscopeUncalibratedDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = GyroscopeUncalibratedLifecycleObserver(
        this,
        this,
        this,
    )

    lateinit var binding: ActivityRawGyroscopeUncalibratedBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawGyroscopeUncalibratedBinding.inflate(layoutInflater)
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unit_gyroscope))
    }
