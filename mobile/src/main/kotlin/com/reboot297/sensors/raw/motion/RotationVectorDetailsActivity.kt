...
import com.reboot297.sensors.databinding.ActivityRawRotationVectorBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.RotationVectorLifecycleObserver

class RotationVectorDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = RotationVectorLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawRotationVectorBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawRotationVectorBinding.inflate(layoutInflater)
