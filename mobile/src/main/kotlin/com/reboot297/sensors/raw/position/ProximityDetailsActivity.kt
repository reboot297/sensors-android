...
import com.reboot297.sensors.databinding.ActivityRawProximityBinding
import com.reboot297.sensors.extensions.handleVisibility
import com.reboot297.sensors.lib.raw.ProximityLifecycleObserver

class ProximityDetailsActivity : BaseSensorValuesDetailsActivity() {
    override val sensorObserver = ProximityLifecycleObserver(this, this, this)

    lateinit var binding: ActivityRawProximityBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRawProximityBinding.inflate(layoutInflater)
    ...
    override fun onSensorAvailable(sensor: Sensor) {
        ...
        binding.sensorInfoLayout.setInfo(sensor, getString(R.string.unit_proximity))
    }
