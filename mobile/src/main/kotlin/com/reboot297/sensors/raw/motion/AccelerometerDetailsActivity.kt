...
import com.reboot297.sensors.databinding.ActivityRawAccelerometerBinding
...
class AccelerometerDetailsActivity : BaseSensorValuesDetailsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawAccelerometerBinding.inflate(layoutInflater)
        ...
        with(binding) {
            ...
            samplesLabelView.handleVisibility(sampleDeviceOrientationView)
