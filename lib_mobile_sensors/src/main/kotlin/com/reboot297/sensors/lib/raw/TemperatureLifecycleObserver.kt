...
/**
 * An example of reading raw data from an Android temperature sensor.
 *
 * This is a deprecated sensor. Please use AmbientTemperature sensor instead.
 */
class TemperatureLifecycleObserver(
    ...
    override fun startListening() {
        sensorManager.registerListener(
            this@TemperatureLifecycleObserver,
            sensor,
