...
class AccelerometerUncalibratedValueView(context: Context, attrs: AttributeSet?) :
    MaterialTextView(context, attrs) {

    private val unit: String

    init {
        unit = context.getString(R.string.unit_acceleration)
    }
