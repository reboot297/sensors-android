...
package com.reboot297.sensors.wear.raw.orientation

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesOrientationBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesOrientationBinding

    private val sensorObserver = OrientationLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesOrientationBinding.inflate(layoutInflater)
