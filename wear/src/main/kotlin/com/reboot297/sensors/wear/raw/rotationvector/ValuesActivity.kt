...
package com.reboot297.sensors.wear.raw.rotationvector

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesRotationVectorBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesRotationVectorBinding

    private val sensorObserver = RotationVectorLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesRotationVectorBinding.inflate(layoutInflater)
