...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesLightBinding
...
class ValuesActivity :
    ...
    ActivityListener {
    private lateinit var binding: ActivityRawDetailsValuesLightBinding

    private val sensorObserver =
        LightLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesLightBinding.inflate(layoutInflater)
