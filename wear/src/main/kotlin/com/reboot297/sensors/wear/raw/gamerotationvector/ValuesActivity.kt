...
package com.reboot297.sensors.wear.raw.gamerotationvector

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesGameRotationVectorBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesGameRotationVectorBinding

    private val sensorObserver = GameRotationVectorLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesGameRotationVectorBinding.inflate(layoutInflater)
