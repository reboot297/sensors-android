...
package com.reboot297.sensors.wear.raw.linearacceleration

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesLinearAccelerationBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesLinearAccelerationBinding

    private val sensorObserver = LinearAccelerationLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesLinearAccelerationBinding.inflate(layoutInflater)
