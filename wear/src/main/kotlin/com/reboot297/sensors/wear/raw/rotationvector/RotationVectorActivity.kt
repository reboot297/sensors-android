...
class RotationVectorActivity : BaseRawSensorActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            labelView.setText(R.string.title_rotation_vector)
            valuesButton.setOnClickListener { openSection(ValuesActivity::class.java) }
            descriptionButton.setOnClickListener { openDetails(R.string.description_rotation_vector) }
