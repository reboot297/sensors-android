...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesStepDetectionBinding
import com.reboot297.sensors.lib.raw.StepDetectorLifecycleObserver
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesStepDetectionBinding

    // TODO(Viktor) permissions
    private val sensorObserver = StepDetectorLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesStepDetectionBinding.inflate(layoutInflater)
