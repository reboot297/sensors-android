...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesAccelerometerBinding
import com.reboot297.sensors.lib.raw.AccelerometerLifecycleObserver
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesAccelerometerBinding

    private val sensorObserver = AccelerometerLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesAccelerometerBinding.inflate(layoutInflater)
