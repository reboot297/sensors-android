...
package com.reboot297.sensors.wear.raw.accelerometeruncalibrated

import android.os.Build
import android.os.Bundle
import androidx.annotation.RequiresApi
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesAccelerometerUncalibratedBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesAccelerometerUncalibratedBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesAccelerometerUncalibratedBinding.inflate(layoutInflater)
