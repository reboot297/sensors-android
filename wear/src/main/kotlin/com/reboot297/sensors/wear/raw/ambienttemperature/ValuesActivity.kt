...
package com.reboot297.sensors.wear.raw.ambienttemperature

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesAmbientTemperattureBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesAmbientTemperattureBinding

    private val sensorObserver = AmbientTemperatureLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesAmbientTemperattureBinding.inflate(layoutInflater)
