...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesSignificantMotionBinding
...
class ValuesActivity : BaseSensorActivity(), SensorTriggerValuesListener, ActivityListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesSignificantMotionBinding.inflate(layoutInflater)
