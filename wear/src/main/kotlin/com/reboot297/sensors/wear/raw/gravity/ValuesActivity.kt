...
package com.reboot297.sensors.wear.raw.gravity

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesGravityBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesGravityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesGravityBinding.inflate(layoutInflater)
