...
class MagneticFieldActivity : BaseRawSensorActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            labelView.setText(R.string.title_magnetic_field)
            valuesButton.setOnClickListener { openSection(ValuesActivity::class.java) }
            descriptionButton.setOnClickListener { openDetails(R.string.description_magnetic_field) }
            infoButton.setOnClickListener { openSection(InfoActivity::class.java) }
            samplesButton.isVisible = true
            samplesButton.setOnClickListener { openSection(SamplesActivity::class.java) }
        }
    }
}
