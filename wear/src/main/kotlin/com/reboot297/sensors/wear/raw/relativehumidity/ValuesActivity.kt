...
package com.reboot297.sensors.wear.raw.relativehumidity

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesRelativeHumidityBinding
import com.reboot297.sensors.lib.raw.RelativeHumidityLifecycleObserver
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesRelativeHumidityBinding

    private val sensorObserver = RelativeHumidityLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesRelativeHumidityBinding.inflate(layoutInflater)
