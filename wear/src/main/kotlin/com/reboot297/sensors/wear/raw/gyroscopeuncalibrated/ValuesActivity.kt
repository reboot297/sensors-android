...
package com.reboot297.sensors.wear.raw.gyroscopeuncalibrated

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesGyroscopeUncalibratedBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesGyroscopeUncalibratedBinding

    private val sensorObserver = GyroscopeUncalibratedLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesGyroscopeUncalibratedBinding.inflate(layoutInflater)
