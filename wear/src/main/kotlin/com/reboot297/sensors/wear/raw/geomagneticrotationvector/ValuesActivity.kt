...
package com.reboot297.sensors.wear.raw.geomagneticrotationvector

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesGeomagneticRotationVectorBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesGeomagneticRotationVectorBinding

    private val sensorObserver = GeomagneticRotationVectorLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesGeomagneticRotationVectorBinding.inflate(layoutInflater)
