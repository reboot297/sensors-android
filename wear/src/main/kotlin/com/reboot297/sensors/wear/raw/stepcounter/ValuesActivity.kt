...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesStepCounterBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesStepCounterBinding.inflate(layoutInflater)
