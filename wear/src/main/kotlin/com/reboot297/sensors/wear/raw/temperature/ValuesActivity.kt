...
package com.reboot297.sensors.wear.raw.temperature

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesTemperatureBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesTemperatureBinding.inflate(layoutInflater)
