...
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesMagneticFieldBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesMagneticFieldBinding

    private val sensorObserver = MagneticFieldLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesMagneticFieldBinding.inflate(layoutInflater)
