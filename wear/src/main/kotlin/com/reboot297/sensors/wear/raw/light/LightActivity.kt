...
class LightActivity : BaseRawSensorActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            labelView.setText(R.string.title_light)
            valuesButton.setOnClickListener { openSection(ValuesActivity::class.java) }
            descriptionButton.setOnClickListener { openDetails(R.string.description_light) }
