...
package com.reboot297.sensors.wear.raw.gyroscope

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesGyroscopeBinding
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesGyroscopeBinding

    private val sensorObserver = GyroscopeLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesGyroscopeBinding.inflate(layoutInflater)
