...
package com.reboot297.sensors.wear.raw.magneticfielduncalibrated

import android.os.Bundle
import com.reboot297.sensors.databinding.ActivityRawDetailsValuesMagneticFieldUncalibratedBinding
import com.reboot297.sensors.lib.raw.MagneticFieldUncalibratedLifecycleObserver
...
class ValuesActivity : BaseSensorActivity(), SensorValuesListener, ActivityListener {
    ...
    private lateinit var binding: ActivityRawDetailsValuesMagneticFieldUncalibratedBinding

    private val sensorObserver = MagneticFieldUncalibratedLifecycleObserver(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRawDetailsValuesMagneticFieldUncalibratedBinding.inflate(layoutInflater)
